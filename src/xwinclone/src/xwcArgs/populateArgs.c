...
populateArgs (arguments * args)
{
    if (   addArg (args, True,  C_STR, BGCOLOR,    "BGCOLOR",
        ...
        || addArg (args, False, INT,   MULTIINST, "MULTIINST",
        ...
        || addArg (args, True,  C_STR,   CONFFILE, "CONFFILE",
                   "Sets name of config file to be used or created "
                   "(see MKCONFIG).",
                   2, "-conff", "-cf")
        == False

        || addArg (args, FALSE,  INT,   MKCONFIG, "MKCONFIG",
        ...
        || addArg (args, True,  C_STR,   EXITKEY, "EXITKEY",
        ...
        || addArg (args, True,  C_STR,   CLONEKEY, "CLONEKEY",
